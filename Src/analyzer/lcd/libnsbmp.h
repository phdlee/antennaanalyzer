...
typedef void (*bmp_bitmap_cb_putcolor)(unsigned int, unsigned int, unsigned int); //Added a callback to put color to given place (YK)
...
typedef struct bmp_bitmap_callback_vt_s
{
    ...
    bmp_bitmap_cb_putcolor bitmap_put_color;  //Added a callback to put color to given place (YK)
...
typedef struct ico_collection
{
    ...
    /** Internal members are listed below
    */
    const uint8_t *ico_data;              /** pointer to ICO data */
