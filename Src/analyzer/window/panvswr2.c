...
"50 kHz","100 kHz", "200 kHz", "500 kHz", "1 MHz", "2 MHz", "5 MHz",\
 ...
 "175 MHz", "200 MHz", "225 MHz", "250 MHz", "350 MHz", "1.0 MHz"};
...
static const TEXTBOX_t tb_menuSWR[] = {
    (TEXTBOX_t){.x0 = 70, .y0 = 237, .text =    "", .font = FONT_FRANBIG,.width = 100, .height = 35, .center = 1,
                 .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = SWR_SetFrequencyMuted , .cbparam = 1, .next = (void*)&tb_menuSWR[1] },
   (TEXTBOX_t){.x0 = 280, .y0 = 237, .text =  "", .font = FONT_FRANBIG,.width = 100, .height = 35, .center = 1,
                 .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = SWR_2 , .cbparam = 1, .next = (void*)&tb_menuSWR[2] },
    (TEXTBOX_t){.x0 = 380, .y0 = 237, .text =  "", .font = FONT_FRANBIG,.width = 100, .height = 35, .center = 1,
                 .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = SWR_3 , .cbparam = 1, .next = (void*)&tb_menuSWR[3] },
    (TEXTBOX_t){.x0 = 190, .y0 = 237, .text =  "", .font = FONT_FRANBIG,.width = 100, .height = 35, .center = 1,
                 .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = SWR_Mute , .cbparam = 1, .next = (void*)&tb_menuSWR[4] },
    (TEXTBOX_t){ .x0 = 0, .y0 = 237, .text = "", .font = FONT_FRANBIG, .width = 80, .height = 35, .center = 1,
                 .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = LCD_RED, .cb = (void(*)(void))SWR_Exit, .cbparam = 1,},
};
...
void SWR_Mute(void){
    if(Tone==0){
        ...
        //FONT_Write(FONT_FRAN, TextColor, BUTTON_BACKCOLOR, 180 + 10, 237 + 10, "Tone");
        ...
        //FONT_Write(FONT_FRAN, LCD_RED, BUTTON_BACKCOLOR, 180 + 10, 237 + 10, "Mute");
    }
    DrawTuneButtonText();
}
...
void SWR_2(void){
    //if(SWRLimit==3)
    //    LCD_Rectangle((LCDPoint){380, 210}, (LCDPoint){476, 244}, 0xffffff00);//yellow
    if(SWRLimit == 2)
    {
        SWRLimit=1;
...
void Tune_SWR_Proc(void){// -----------------------------------------------------------------------
    ...
    */
    ...
    LCD_DrawBitmap(LCD_MakePoint(80, 237), imgbtn_empty2, imgbtn_empty2_size);
    FONT_Write(FONT_FRAN, TextColor, 0, 80 + 10, 237 + 10, "Set Frequency");
    LCD_DrawBitmap(LCD_MakePoint(180,237), imgbtn_empty2, imgbtn_empty2_size);
    LCD_DrawBitmap(LCD_MakePoint(280,237), imgbtn_empty2, imgbtn_empty2_size);
    LCD_DrawBitmap(LCD_MakePoint(380,237), imgbtn_empty2, imgbtn_empty2_size);
    DrawTuneButtonText();
...
int ShowFreq(int indx)
{
    ...
    if(freqx == 0)
    {
        LCD_FillRect((LCDPoint){2, YY0-9+lineOffset}, (LCDPoint){480, YY0 + 30 + lineOffset}, BackGrColor);
...
static const TEXTBOX_t tb_PANVSWR[] = {
   ...
   (TEXTBOX_t){.x0 = 410, .y0 = 248, .text ="Scan", .font = FONT_FRAN,.width = 67, .height = 22, .center = 1,
